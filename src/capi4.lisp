...
(defpackage #:tesseract-capi/v4
  (:use #:cl #:cffi))

(in-package :tesseract-capi/v4)
...
(cffi:defcfun ("TessBaseAPIGetAltoText" TessBaseAPIGetAltoText) :string
  (handle :pointer)
  (page_number :int))

(cffi:defcfun ("TessBaseAPIGetTsvText" TessBaseAPIGetTsvText) :string
  (handle :pointer)
  (page_number :int))
...
(cffi:defcfun ("TessBaseAPIGetLSTMBoxText" TessBaseAPIGetLSTMBoxText) :string
  (handle :pointer)
  (page_number :int))

(cffi:defcfun ("TessBaseAPIGetWordStrBoxText" TessBaseAPIGetWordStrBoxText) :string
  (handle :pointer)
  (page_number :int))
...
(let ((pack (find-package :tesseract-capi/v4)))
